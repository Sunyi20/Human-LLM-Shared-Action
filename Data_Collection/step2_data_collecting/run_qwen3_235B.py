...
base_result_dir = project_path(
    "run_experiment",
    "results_qwen3_235B_full_sample",
    f"results_qwen3_235B_full_sample_triplets_split_{number}",
)
...
csv_save_name = os.path.join(base_result_dir, f'train_chains&responses_qwen3_235B_full_sample_split_{number}_file.csv')
