...
triplet_file_path = project_path(
    "list", "full_sample_human", f"human_full_sample_triplets_segment_{number}.txt"
)
transciptions_folder = project_path("data", "transcriptions_selected")
base_result_dir = project_path(
    "run_experiment",
    "results_gpt_oss_120b_full_sample",
    f"results_gpt_oss_120b_full_sample_triplets_split_{number}",
)
...
csv_save_name = os.path.join(base_result_dir, f'train_chains&responses_gpt_oss_120B_full_sample_split_{number}_file.csv')
...
# Manual override: process only the four triplets below
# Comment out the next line to process every triplet from the input file
# triplets = [
#     '35 173 257',
#     '114 114 114',
#     '5 97 216',
