...
base_dir = f'/data1/home/sunyi/large-files/Python_Objects/human_action/consistency_plot/data/human_all_models_triplets_{num_objects}/feature_calculate/reshape/'
all_rdms = {}
all_splithalf_rdms = {}
...
for model in model_sets:
    ...
    # Construct the filename based on the pattern in the screenshot
    # filename = f'triplets_sorted_{model}_reshape.txt'
    filename = f'triplets_sorted_{model}_rdm_euclidean_reshape.txt'
    ...
    sio.savemat('data/consistency_plot/human_all_models_RSMs/RSM41_feature_models.mat', all_rdms)
    sio.savemat('data/consistency_plot/human_all_models_RSMs/RSM41_feature_models_splithalf.mat', all_splithalf_rdms)