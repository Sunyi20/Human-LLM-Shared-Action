...
load(fullfile('data/LLM_qwen_7B/qwen_7B_spose_embedding_sorted_final.txt'));
spose_embedding = qwen_7B_spose_embedding_sorted_final;
...
xlabel('Qwen2.5-7B Dimension', 'FontSize', 20);
exportgraphics(fig, 'reordered_corr_matrix_human_llm_qwen_7B.pdf', 'ContentType', 'vector');
