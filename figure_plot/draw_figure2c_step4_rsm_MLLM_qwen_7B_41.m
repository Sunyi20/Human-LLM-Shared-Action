...
% load embedding
spose_embedding = load(fullfile('data/MLLM_qwen_7B/qwen_7B_VL_spose_embedding_sorted_full_sample.txt'));

dot_product = spose_embedding*spose_embedding';

% load RDM
load(fullfile('data/MLLM_qwen_7B/RDM_48_MLLM_qwen_7B.mat'));
...
annotation('textbox', [0, 0.88, 1, 0.1], ...
           'String', 'Qwen2.5-VL-7B: Comparison of Predicted and Measured RSMs', ...
           'EdgeColor', 'none', ...
           'HorizontalAlignment', 'center', ...
           'FontSize', 22, ...
           'FontWeight', 'bold');
...
if ~exist('dosave', 'var') || dosave
    exportgraphics(fig, 'figures/RSM_Qwen2_5_VL_7B_41.pdf', ...
                   'ContentType', 'vector', ...
                   'Resolution', 400);
end
