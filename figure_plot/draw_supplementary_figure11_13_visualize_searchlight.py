...
if __name__ == '__main__':
    ...
    parser.add_argument('--vmax', type=float, default=0.20261883563715102)
    ...
    for model_name in MODELS:
        npy_path = os.path.join(args.data_dir, f"{model_name}_group_average_searchlight_r_values.npy")
        ...
        output_image_path = os.path.join(args.output_dir, f"searchlight_{model_name}_main.pdf")
