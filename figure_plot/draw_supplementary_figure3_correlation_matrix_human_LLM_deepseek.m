...
load(fullfile('data/LLM_deepseek/deepseek_spose_embedding_sorted_final.txt'));
spose_embedding = deepseek_spose_embedding_sorted_final;
...
xlabel('Deepseek-R1 Dimension', 'FontSize', 20);
exportgraphics(fig, 'reordered_corr_matrix_human_llm_deepseek.pdf', 'ContentType', 'vector');
