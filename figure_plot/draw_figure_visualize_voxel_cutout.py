...
if __name__ == '__main__':
    subject_id = 'NHB2026'
    parser = argparse.ArgumentParser(description="Pycortex")
    parser.add_argument(
        '--data_dir', 
    ...
    parser.add_argument(
        '--output_dir', 
        default='data/pycortex/results_pdf/cutout_2',
    )
    ...
    for model_name in MODELS:
        ...
        output_image_path = os.path.join(args.output_dir, f"voxel_{model_name}_cutout_2.pdf")

        fig = cortex.quickshow(pycortex_data, with_colorbar=False, with_curvature=True, recache=True, with_rois=True, with_labels=False, cutout="cutout_visualize_2")
