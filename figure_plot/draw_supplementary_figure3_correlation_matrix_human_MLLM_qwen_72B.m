...
load(fullfile('data/MLLM_qwen_72B/qwen_72B_VL_spose_embedding_sorted_final.txt'));
spose_embedding = qwen_72B_VL_spose_embedding_sorted_final;
...
xlabel('Qwen2.5-VL-72B Dimension', 'FontSize', 20);
exportgraphics(fig, 'reordered_corr_matrix_human_mllm_qwen_72B.pdf', 'ContentType', 'vector');
