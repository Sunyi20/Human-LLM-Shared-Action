...
# Searchlight
LLM_deepseek_searchlight = pd.read_csv(os.path.join(base_path, "searchlight_results_csv/LLM_deepseek_searchlight_results.csv"))
LLM_qwen7B_searchlight = pd.read_csv(os.path.join(base_path, "searchlight_results_csv/LLM_qwen_7B_searchlight_results.csv"))
MLLM_qwen7B_searchlight = pd.read_csv(os.path.join(base_path, "searchlight_results_csv/MLLM_qwen_7B_searchlight_results.csv"))
MLLM_qwen72B_searchlight = pd.read_csv(os.path.join(base_path, "searchlight_results_csv/MLLM_qwen_72B_searchlight_results.csv"))
...
searchlight_data['model_type'] = pd.Categorical(searchlight_data['model_type'], categories=model_levels, ordered=True)
...
searchlight_fig = draw_comparison_plot(searchlight_data, ylabel="RSA score")

os.makedirs("figures", exist_ok=True)
searchlight_fig.savefig(os.path.join(os.getcwd(), "figures/searchlight_comparison.pdf"), bbox_inches='tight')
