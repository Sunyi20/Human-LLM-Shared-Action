...
% load embedding
spose_embedding = load('data/LLM_qwen_7B/qwen_7B_spose_embedding_sorted_final.txt');
dim = size(spose_embedding,2);
dosave = 1;

refdir = fullfile('data/LLM_qwen_7B/reference_models_qwen_spose_threshold_0.25');
for i_model = 1:65
...
hax.LineWidth = 1.5; 
if dosave
    exportgraphics(fig, 'dim_reproducibility_LLM_qwen_7B.pdf', 'ContentType', 'vector');
end
